...

{
  ...
  # and is used to maintain compatibility with application data (e.g. databases) created under older NixOS versions.
  #
  # Most users should NEVER change this value after the initial install, for any reason,
  # even if you've upgraded your NixOS release.
  #
  # This value being lower than the current NixOS release does not mean
  # the system is out of date. See `man configuration.nix` for details.
