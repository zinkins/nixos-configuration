...
- [`docs/FAMILY-LOCATION.md`](docs/FAMILY-LOCATION.md)
...
- [`nix/family-location.nix`](nix/family-location.nix)
- [`nix/family-location-dashboard.nix`](nix/family-location-dashboard.nix)
